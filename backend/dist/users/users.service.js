...
let UsersService = class UsersService {
    ...
    async create(createUserDto) {
        try {
            ...
            if (existingUser) {
                throw new common_1.ConflictException(`El nombre de usuario '${createUserDto.username}' ya está en uso`);
            }
            const saltRounds = 10;
    ...
    async update(id, updateUserDto) {
        ...
        if (updateUserDto.username) {
            ...
            if (existingUser && existingUser.id !== id) {
                throw new common_1.ConflictException(`El nombre de usuario '${updateUserDto.username}' ya está en uso`);
            }
        }
